export const Strings = {
  ...
  confirmDeleteAddress: 'Are you sure you want to delete the',
  confirmDeleteAddress2: 'address from your address list?',
  yesDelete: 'Yes, Delete',
  referScreenHeadline: 'Refer a friend, get 3 free deliveries!',
  referScreenSub:
    "Share your code with friends! Make sure they use it while signing up and you'll get 3 free deliveries each. It's a win-win :)",
  seeInvites: 'See your previous invites',
  ...
  whatsappHelp: 'You can contact us on whatsapp',
  email: 'Email',
  customerSupport: 'Customer Support',
  helpText: 'We are there to help you 24/7',
  accountSetupNameHeadline: 'Let us know your name please',
